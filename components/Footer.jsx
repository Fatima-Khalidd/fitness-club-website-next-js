...
console.log("🔴🔴🔴 USING THE CORRECT FOOTER FILE: components/Footer.jsx 🔴🔴🔴")
    ...
    <footer className="bg-neutral-950 border-t border-white/10 text-gray-300">
        ...
        <div className="grid gap-8 sm:gap-10 md:gap-12 lg:gap-14 md:grid-cols-12">
          ...
          <nav className="md:col-span-2 space-y-3 sm:space-y-4">
            ...
            <ul className="space-y-2 sm:space-y-3 text-sm">
              <li><Link href="/aboutus" className="hover:text-red-500 transition-colors duration-200">About Us</Link></li>
              <li><Link href="/trainers" className="hover:text-red-500 transition-colors duration-200">Trainers</Link></li>
              <li><Link href="/classes" className="hover:text-red-500 transition-colors duration-200">Classes</Link></li>
              <li><Link href="/pricing" className="hover:text-red-500 transition-colors duration-200">Pricing</Link></li>
            </ul>
          </nav>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
          <div className="text-center text-xs sm:text-sm text-gray-400 space-y-1 sm:space-y-1.5">
            <p>
